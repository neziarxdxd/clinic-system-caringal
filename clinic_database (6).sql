...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2021 at 10:21 AM
...
(500034, 0, '', '', ''),
(500035, 0, 'j', '', 'h'),
(500036, 0, 'kkkk', 'regular', 'kkk'),
(500037, 0, 'Janny', '', 'Edgard Universe'),
(500038, 0, 'kjh', '', 'kk'),
(500039, 0, 'kkkk', '', 'fdfjdfj'),
(500040, 0, 'kkk', '', 'kk');
...
(2, 'Dra. Eden Caringal'),
(3, 'Dra. Justine Vera Dennys Caringal');
...
(2000043, 'kkkk', '2021-06-14 07:30:44', 'lllkj', 'llkjjkjjk'),
(2000044, 'Janny', '2021-06-14 08:03:43', 'lllkj', 'GCASH'),
(2000045, 'kjh', '2021-06-14 08:06:10', 'lllkj', 'kl'),
(2000046, 'kkkk', '2021-06-14 08:07:55', 'lllkj', 'kkkj'),
(2000047, 'kkk', '2021-06-14 08:08:36', 'lllkj', 'kk');
...
(43, 'sdfewkfkr', 2000028, 'Dr. Diosdado Emmanuel S. Caringal', '500', '2021-06-03 01:07:38', 1, 500),
...
(63, 'Professional Fee + Procedure', 2000043, 'Dr. Diosdado Emmanuel S. Caringal', '500', '2021-06-14 07:30:44', 1, 500),
(64, 'Antibiotics', 2000043, 'Dr. Diosdado Emmanuel S. Caringal', '3006', '2021-06-14 07:30:44', 1, 3006),
(65, 'ECG', 2000043, 'Dr. Diosdado Emmanuel S. Caringal', '8660', '2021-06-14 07:30:44', 1, 8660),
(66, 'Professional Fee + Procedure', 2000044, 'Dr. Diosdado Emmanuel S. Caringal', '500', '2021-06-14 08:03:43', 1, 500),
(67, 'Antibiotics', 2000045, 'Dr. Diosdado Emmanuel S. Caringal', '3006', '2021-06-14 08:06:10', 1, 3006),
(68, 'Professional Fee + Procedure', 2000045, 'Dr. Diosdado Emmanuel S. Caringal', '500', '2021-06-14 08:06:10', 1, 500),
(69, 'Professional Fee + Procedure', 2000046, 'Dr. Diosdado Emmanuel S. Caringal', '500', '2021-06-14 08:07:55', 1, 500),
(70, 'Antibiotics', 2000046, 'Dr. Diosdado Emmanuel S. Caringal', '3006', '2021-06-14 08:07:55', 1, 3006),
(71, 'ECG', 2000046, 'Dr. Diosdado Emmanuel S. Caringal', '8660', '2021-06-14 08:07:55', 1, 8660),
(72, 'Professional Fee + Procedure', 2000047, 'Dra. Eden Caringal', '500', '2021-06-14 08:08:36', 1, 500);
...
--
ALTER TABLE `tbl_customer`
  MODIFY `customer_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=500041;
...
--
ALTER TABLE `tbl_invoice`
  MODIFY `invoice_number` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2000048;

--
-- AUTO_INCREMENT for table `tbl_list_service`
--
ALTER TABLE `tbl_list_service`
  MODIFY `id_list_service` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;

--
-- AUTO_INCREMENT for table `tbl_secretary`
--
ALTER TABLE `tbl_secretary`
  MODIFY `secretary_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
